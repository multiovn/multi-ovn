...
import (
	...
	ovnv1clientset "github.com/multiovn/multi-ovn/pkg/client/clientset/versioned"
...
type Configuration struct {
	...
	Crdclientset   ovnv1clientset.Interface
	NodeName       string
}
...
func (config *Configuration) initKubeClient() error {
	...
	crdclientset, err := ovnv1clientset.NewForConfig(cfg)
	if err != nil {
		klog.Errorf("init crd client failed %v", err)
		return err
	}

	config.KubeClient = kubeClient
	config.Crdclientset = crdclientset
	return nil
}
