	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MultiovnV1().ACLs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MultiovnV1().ACLs(namespace).Watch(context.TODO(), options)
			},
		},
		&apismultiovnv1.ACL{},
		resyncPeriod,
...
func (f *aCLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismultiovnv1.ACL{}, f.defaultInformer)
}

func (f *aCLInformer) Lister() multiovnv1.ACLLister {
	return multiovnv1.NewACLLister(f.Informer().GetIndexer())
}
