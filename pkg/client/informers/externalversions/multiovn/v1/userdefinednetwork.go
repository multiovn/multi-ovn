...
type UserDefinedNetworkInformer interface {
	...
	Lister() multiovnv1.UserDefinedNetworkLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MultiovnV1().UserDefinedNetworks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MultiovnV1().UserDefinedNetworks(namespace).Watch(context.TODO(), options)
			},
		},
		&apismultiovnv1.UserDefinedNetwork{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *userDefinedNetworkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismultiovnv1.UserDefinedNetwork{}, f.defaultInformer)
}

func (f *userDefinedNetworkInformer) Lister() multiovnv1.UserDefinedNetworkLister {
	return multiovnv1.NewUserDefinedNetworkLister(f.Informer().GetIndexer())
}
