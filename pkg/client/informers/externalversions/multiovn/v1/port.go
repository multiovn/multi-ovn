	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MultiovnV1().Ports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MultiovnV1().Ports(namespace).Watch(context.TODO(), options)
			},
		},
		&apismultiovnv1.Port{},
		resyncPeriod,
...
func (f *portInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismultiovnv1.Port{}, f.defaultInformer)
}

func (f *portInformer) Lister() multiovnv1.PortLister {
	return multiovnv1.NewPortLister(f.Informer().GetIndexer())
}
